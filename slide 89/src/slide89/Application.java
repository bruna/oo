...
public class Application{
	public static void main(String args[]){
		...
		ze.setAumento();
		ze.imprimir();
		System.out.println("eu sou um rodape ");
		...
		//Sobrecarga do método imprimir
		
		Cabecalho cabecalho = new Cabecalho();
		cabecalho.setCabecalho("< Eu sou um cabeçalho >");
		
		Rodape rodape = new Rodape();
		rodape.setRodape("< Eu sou um rodapé >");
		
		joao.imprimir();
		System.out.println("");
		joao.imprimir(cabecalho);
		System.out.println("");
		joao.imprimir(cabecalho, rodape);
		System.out.println("");
		joao.imprimir(rodape);	
	}
}